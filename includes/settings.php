...
/*
|-------------------------------------------------------------------------------------
| Feature By | Bipin Guragain: Settings page with photo upload features and many more.
|-------------------------------------------------------------------------------------
*/

// ── Handle profile photo upload ───────────────────────────────
// AP-44 CSRF | Feature Maker: Bipin Guragain — Protect photo upload form
// NOTE: This block MUST run before header.php is included (which outputs HTML),
//       because redirect() uses header() which cannot be sent after output.
...
// Now include header (outputs HTML — must be after all redirects)
    ...
    <div class="settings-main">
        ...
        <div class="settings-section">
            ...
            <div class="settings-section-body">
                ...
                <a href="#" data-logout-trigger class="security-card" style="text-decoration:none;display:flex;margin-top:12px;border-color:var(--herald-red);background:rgba(220,53,69,0.05);">
                    <div class="security-card-icon" style="color:var(--herald-red);background:rgba(220,53,69,0.1);">
                        <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1"/>
                        </svg>
                    </div>
                    <div class="security-card-text">
                        <h3 style="color:var(--herald-red);">Log Out</h3>
                        <p>Sign out of your Herald account</p>
                    </div>
                    <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"
                         style="width:16px;height:16px;color:var(--herald-red);align-self:center;flex-shrink:0;">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7"/>
                    </svg>
                </a>
            </div>
