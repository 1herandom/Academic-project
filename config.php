...
function require_role(array|string $allowedRoles): void {
    ...
    if (!in_array($role, $allowed, true)) {
        ...
        echo '<!DOCTYPE html><html><head><meta charset="utf-8"><title>403 Access Denied</title><link rel="stylesheet" href="' . APP_BASE_URL . '/assets/style.css"></head><body class="auth-shell"><div class="card centered"><h1>403 - Access Denied</h1><p>You do not have permission to view this page.</p><a class="btn" href="' . APP_BASE_URL . '/dashboard.php">Go to Dashboard</a></div></body></html>';
        exit;
    }
}
