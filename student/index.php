...
function attendance_badge(float $pct): array {
    ...
    if ($pct >= 50) return ['gold', 'At Risk',   'warn'];
...
<div class="grid-3">
    <div class="stat green">
        ...
        <div style="font-size:10px; font-weight:700; text-transform:uppercase; letter-spacing:0.1em; opacity:0.6; margin-top:-4px;">Courses</div>
    </div>
...
<div class="grid-3">
    <div class="panel stat-panel">
        <div class="stat-icon stat-icon-green">
            <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" class="stat-svg">
                <path stroke-linecap="round" stroke-linejoin="round"
                      d="M16 8v8m-4-5v5m-4-2v2m-2 4h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"/>
            </svg>
        </div>
        <div>
            <div class="stat-text">Attendance Summary</div>
    ...
    <div class="panel stat-panel">
        ...
        <div>
            <div class="stat-text">L / T / W Split</div>
            <p class="small">Open course details to see Lecture, Tutorial, and Workshop breakdowns.</p>
        </div>
    </div>
    <div class="panel stat-panel">
        <div class="stat-icon" style="background:rgba(228,145,166,0.12); color:var(--herald-red);">
            <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" class="stat-svg">
        ...
        <div>
            <div class="stat-text">Assignments</div>
...
<div class="grid-2">
    ...
    ?>
    <div class="panel">
        <div class="d-flex flex-justify-between flex-align-start mb-3">
            <div>
        ...
        <div class="progress <?= $progressClass ?> mb-3">
            <span style="width:<?= min(100, $pct) ?>%"></span>
        </div>

        <div style="font-size:22px;font-weight:800;letter-spacing:-0.5px;
                    color:<?= $pct >= 75 ? 'var(--herald-green)' : ($pct >= 50 ? 'var(--herald-gold)' : 'var(--herald-red)') ?>;
