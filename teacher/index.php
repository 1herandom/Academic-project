...
<div class="grid-3 mb-6">
    ...
    <div class="panel">
        <div class="d-flex flex-align-center gap-3 mb-3">
            <div style="width:40px;height:40px;border-radius:10px;background:rgba(104,186,127,0.12);
        ...
        <p class="small mb-4">Record L / T / W session type attendance for your enrolled students. Bulk mark all present with one click.</p>
    ...
    <div class="panel">
        ...
        <p class="small mb-4">Publish tasks with deadlines, add brief files, and share lecture notes and lab resources with students.</p>
    ...
    <div class="panel">
        <div class="d-flex flex-align-center gap-3 mb-3">
            <div style="width:40px;height:40px;border-radius:10px;background:rgba(228, 145, 166, 0.12);
            ...
            <h3 style="margin:0;font-size:16px;font-weight:700;">Student Performance</h3>
        </div>
        <p class="small mb-4">Monitor student analytics, attendance rates, and submission progress across your assigned courses.</p>
        <a class="btn" href="<?= APP_BASE_URL ?>/teacher/performance.php" style="background:var(--herald-red);">View Analytics</a>
    </div>
